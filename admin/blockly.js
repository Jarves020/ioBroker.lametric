    ...
    init: function() {
        ...
        if (typeof main !== 'undefined' && main.instances) {
            for (var i = 0; i < main.instances.length; i++) {
                var m = main.instances[i].match(/^system.adapter.lametric.(\d+)$/);
                if (m) {
        ...
        this.appendValueInput('MESSAGE')
            .appendField(Blockly.Translate('lametric_message'));
        ...
        this.appendValueInput('ICON')
            .appendField(Blockly.Translate('lametric_icon'));
        ...
        this.appendValueInput('LIFETIME')
            .appendField(Blockly.Translate('lametric_lifetime'));

        this.appendValueInput('CYCLES')
            .appendField(Blockly.Translate('lametric_cycles'));
...
Blockly.JavaScript['lametric'] = function(block) {
    ...
    lifeTime && objText.push('lifeTime: ' + lifeTime);
